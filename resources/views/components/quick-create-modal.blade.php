...
<div x-show="quickCreateOpen" x-cloak
 ...
 :class="quickCreateTab === tab ? 'border-[#6366F1] text-[#6366F1]' : 'border-transparent text-[#6B7280]'"
 ...
 <input type="text" required class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="Acme Inc">
 </div>
 <div>
 <label class="block text-sm font-medium text-[#6B7280] mb-1">Contact Person</label>
 <input type="text" class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="John Smith">
 </div>
 <div>
 <label class="block text-sm font-medium text-[#6B7280] mb-1">Email *</label>
 <input type="email" required class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="john@acme.com">
 </div>
 <button type="submit" class="w-full py-2.5 bg-[#6366F1] text-white rounded-lg font-medium hover:opacity-90 transition-opacity">Create Client</button>
 </form>
 {{-- New Project --}}
 ...
 <input type="text" required class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="Website Redesign">
 </div>
 <div>
 <label class="block text-sm font-medium text-[#6B7280] mb-1">Client</label>
 <select class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent">
 ...
 <input type="date" class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent">
 </div>
 <button type="submit" class="w-full py-2.5 bg-[#6366F1] text-white rounded-lg font-medium hover:opacity-90 transition-opacity">Create Project</button>
 </form>
 {{-- New Task --}}
 ...
 <input type="text" required class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="Design homepage mockup">
 </div>
 <div>
 ...
 <button type="submit" class="w-full py-2.5 bg-[#6366F1] text-white rounded-lg font-medium hover:opacity-90 transition-opacity">Create Task</button>
 </form>
 {{-- New Invoice --}}
 ...
 <input type="number" step="0.01" class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="2500.00">
 </div>
 <div>
 <label class="block text-sm font-medium text-[#6B7280] mb-1">Due Date</label>
 <input type="date" class="w-full px-4 py-2 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent">
 </div>
 <button type="submit" class="w-full py-2.5 bg-[#6366F1] text-white rounded-lg font-medium hover:opacity-90 transition-opacity">Create Invoice</button>
 </form>
 {{-- New Payment --}}
 ...
 <button type="submit" class="w-full py-2.5 bg-[#6366F1] text-white rounded-lg font-medium hover:opacity-90 transition-opacity">Record Payment</button>
 </form>
 </div>
 </div>
</div>
