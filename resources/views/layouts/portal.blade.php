    ...
    <nav class="bg-white border-b border-[#E2E8F0] sticky top-0 z-30">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    <div class="flex-shrink-0 flex items-center">
                        ...
                        <div class="w-8 h-8 bg-[#4F7CFF] rounded flex items-center justify-center text-white font-bold mr-2">A</div>
                    ...
                    <div class="hidden sm:-my-px sm:ml-8 sm:flex sm:space-x-8">
                        <a href="{{ route('portal.dashboard') }}" class="{{ request()->routeIs('portal.dashboard') ? 'border-[#4F7CFF] text-[#0F172A]' : 'border-transparent text-[#64748B] hover:text-[#0F172A] hover:border-[#CBD5E1]' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Dashboard</a>
                        <a href="{{ route('portal.projects') }}" class="{{ request()->routeIs('portal.projects') ? 'border-[#4F7CFF] text-[#0F172A]' : 'border-transparent text-[#64748B] hover:text-[#0F172A] hover:border-[#CBD5E1]' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Projects</a>
                        <a href="{{ route('portal.invoices') }}" class="{{ request()->routeIs('portal.invoices') ? 'border-[#4F7CFF] text-[#0F172A]' : 'border-transparent text-[#64748B] hover:text-[#0F172A] hover:border-[#CBD5E1]' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Invoices</a>
                    </div>
                </div>
                <div class="hidden sm:ml-6 sm:flex sm:items-center">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center gap-2 p-1.5 rounded-lg hover:bg-[#F1F5F9] transition-colors">
                            <div class="w-8 h-8 rounded bg-[#EEF2FF] text-[#4F7CFF] flex items-center justify-center font-medium">JS</div>
        ...
        <div x-show="mobileNavOpen" class="sm:hidden border-t border-[#E2E8F0] bg-white">
            <div class="pt-2 pb-3 space-y-1 block">
                <a href="{{ route('portal.dashboard') }}" class="{{ request()->routeIs('portal.dashboard') ? 'bg-[#EEF2FF] border-[#4F7CFF] text-[#4F7CFF]' : 'border-transparent text-[#64748B] hover:bg-[#F8FAFC] hover:border-[#CBD5E1] hover:text-[#0F172A]' }} block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Dashboard</a>
                <a href="{{ route('portal.projects') }}" class="{{ request()->routeIs('portal.projects') ? 'bg-[#EEF2FF] border-[#4F7CFF] text-[#4F7CFF]' : 'border-transparent text-[#64748B] hover:bg-[#F8FAFC] hover:border-[#CBD5E1] hover:text-[#0F172A]' }} block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Projects</a>
                <a href="{{ route('portal.invoices') }}" class="{{ request()->routeIs('portal.invoices') ? 'bg-[#EEF2FF] border-[#4F7CFF] text-[#4F7CFF]' : 'border-transparent text-[#64748B] hover:bg-[#F8FAFC] hover:border-[#CBD5E1] hover:text-[#0F172A]' }} block pl-3 pr-4 py-2 border-l-4 text-base font-medium">Invoices</a>
            </div>
            <div class="pt-4 pb-3 border-t border-[#E2E8F0]">
                <div class="flex items-center px-4">
                    <div class="w-10 h-10 rounded bg-[#EEF2FF] text-[#4F7CFF] flex items-center justify-center font-bold text-lg">JS</div>
                    <div class="ml-3">
