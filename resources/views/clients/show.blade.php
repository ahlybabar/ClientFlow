...
<nav class="flex items-center gap-2 text-sm text-[#64748B]">
    ...
    <span>/</span>
    <a href="{{ route('clients.index') }}" class="hover:text-[#4F46E5]">Clients</a>
    <span>/</span>
...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('projects.index') }}" class="px-4 py-2 bg-[#4F46E5] text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity inline-flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl p-6 border border-[#E2E8F0] shadow-sm transition-colors">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('projects.index') }}" class="text-sm font-medium text-[#4F46E5] hover:underline">View all</a>
                </div>
                <div class="relative pl-6 border-l-2 border-[#E2E8F0] space-y-6">
                    ...
                    <div class="relative flex items-start gap-4">
                        <span class="absolute -left-6 w-3 h-3 rounded-full {{ $p['status'] === 'Completed' ? 'bg-[#22C55E]' : 'bg-[#4F46E5]' }} -translate-x-1/2 top-1.5"></span>
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="mt-2 h-1.5 bg-[#E2E8F0] rounded-full overflow-hidden">
                                <div class="h-full bg-[#4F46E5] rounded-full progress-animated" style="width: {{ $p['progress'] }}%"></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="bg-white rounded-xl p-6 border border-[#E2E8F0] shadow-sm transition-colors">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3 py-3 border-b border-[#F1F5F9] last:border-0">
                        <div class="w-9 h-9 rounded-lg bg-[#EEF2FF] flex items-center justify-center text-[#4F46E5] shrink-0">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl p-6 border border-[#E2E8F0] shadow-sm transition-colors">
                ...
                <button class="text-sm font-medium text-[#4F46E5] hover:underline">Add note</button>
            </div>
        </div>
    </div>
</div>
