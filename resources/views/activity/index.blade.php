...
<nav class="flex items-center gap-2 text-sm text-[#64748B]">
    ...
    <span>/</span>
    <span class="text-[#0F172A] font-medium">Activity</span>
</nav>
@endsection

@section('content')
<div class="max-w-3xl mx-auto space-y-6">
    <h1 class="text-2xl font-bold text-[#0F172A]">Activity Timeline</h1>

    <div class="space-y-0 bg-white rounded-xl border border-[#E2E8F0] overflow-hidden">
        @foreach([
        ...
        <div class="flex gap-4 px-6 py-4 border-b border-[#E2E8F0] last:border-0 hover:bg-[#F8FAFC] transition-colors">
            <div class="w-10 h-10 rounded-full bg-[#EEF2FF] flex items-center justify-center text-[#4F46E5] shrink-0">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
            </div>
            <div class="flex-1 min-w-0">
                <p class="font-medium text-[#0F172A]">{{ $a['event'] }}</p>
